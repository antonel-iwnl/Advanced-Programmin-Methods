...
public class unitTesting {
    ...
    public void testAddVehicle() throws DuplicateEntityException {
        {
            Vehicle v = new Vehicle(9, "Audi A7", "Sedan", "Nardo Gray", 2022, 78200, 1500, false);
            serv.addVehicle(v);
    ...
    public void testUpdateVehicle() {
        {
            Vehicle v = new Vehicle(1, "Audi A4", "Wagon", "black", 2010, 10000, 100000, false);
    ...
    @Test
    public void testTextFileRepository() throws DuplicateEntityException, NonExistingEntityException {
        RIdentifiable <Integer, Vehicle> vehRepo = new VehicleRepositoryTextFile("vehicles.txt");
        Vehicle v = new Vehicle(9, "Audi A7", "Sedan", "Nardo Gray", 2022, 78200, 1500, false);
        vehRepo.add(v);
        assertEquals(vehRepo.getAll().spliterator().getExactSizeIfKnown(), 9);
        vehRepo.delete(9);
        assertEquals(vehRepo.getAll().spliterator().getExactSizeIfKnown(), 8);
        Vehicle v2 = new Vehicle(1, "Audi A4", "Wagon", "black", 2010, 10000, 100000, false);
        vehRepo.update(v2);
        ...
        assertEquals(vehRepo.findById(1).getIsRented(), false);
        Vehicle v3 = new Vehicle(9, "Audi A7", "Sedan", "Nardo Gray", 2022, 78200, 1500, false);
        vehRepo.add(v3);
        assertEquals(vehRepo.getAll().spliterator().getExactSizeIfKnown(), 9);
        vehRepo.delete(9);
        assertEquals(vehRepo.getAll().spliterator().getExactSizeIfKnown(), 8);
    ...
    @Test
    public void testBinaryFileRepository() throws DuplicateEntityException, NonExistingEntityException {
        RIdentifiable <Integer, Vehicle> vehRepo = new VehicleRepositoryBinaryFile("vehicles.bin");
        Vehicle v = new Vehicle(9, "Audi A7", "Sedan", "Nardo Gray", 2022, 78200, 1500, false);
        vehRepo.add(v);
        assertEquals(vehRepo.getAll().spliterator().getExactSizeIfKnown(), 8);
        vehRepo.delete(9);
        assertEquals(vehRepo.getAll().spliterator().getExactSizeIfKnown(), 7);
        Vehicle v2 = new Vehicle(1, "Audi A4", "Wagon", "black", 2010, 10000, 100000, false);
        vehRepo.add(v);
        vehRepo.update(v2);
        assertEquals(vehRepo.findById(1).getName(), "Audi A4");
